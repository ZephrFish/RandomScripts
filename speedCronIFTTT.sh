#!/usr/bin/env bash
# Speedtest Script for Cron Jobs, runs against IFTTT 
# https://ifttt.com/applets/55297264d-speedtest to setup, then navigate to maker web hooks to get your secret key
# Edit Line 78 to add your key
...
log=/home/$user/speedtest-ifttt.log
